...
but they are only known up to a transformation or quantification. Ever since @kruskal_64a
...
The distinction between *single phase* and *double phase* NMDS algorithms, names we borrow from @guttman_68 (see also @lingoes_roskam_73), has caused a great deal of confusion in the
early stages of non-metric MDS (say between 1960 and 1970). Because I have been an
active participant (with Carroll, Kruskal, Guttman, Young, and Lingoes) in discussing and perhaps perpetuating this confusion (@deleeuw_R_73g) I will pay some extra attention to it.
